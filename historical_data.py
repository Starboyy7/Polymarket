"""
Mercados historicos de Polymarket ya resueltos para backtesting.
Cada entrada refleja el estado del mercado en el momento de analisis
(precio y noticias disponibles en ese momento) + el outcome real.
"""
from datetime import datetime, timedelta
from models import Market, NewsItem

# Fecha base simulada: 3 meses atras
...
HISTORICAL_MARKETS = [
    ...
    # 3. Trump tariff EO in Q1 2026 -- RESOLVIO: YES
    (
        Market(id="h003", question="Will Trump sign an executive order expanding tariffs in Q1 2026?",
               ...
               url="https://polymarket.com/markets?_q=trump+tariff+executive+order+2026"),
        [
    ...
    # 5. S&P 500 > 5800 by Feb 2026 -- RESOLVIO: YES
    (
        Market(id="h005", question="Will the S&P 500 close above 5800 before March 1, 2026?",
               ...
               url="https://polymarket.com/markets?_q=sp500+5800+2026"),
        [
