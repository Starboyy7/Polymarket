"""Capa 3 — Modelado: simulacion de crowd (LLM) + base rates bayesianas."""
import json
import logging
...
def simulate_crowd_reaction(signal: FilteredSignal) -> CrowdSignal:
    """LLM simulates Twitter/Reddit crowd reaction to a filtered news signal."""
...
def compute_combined_prior(
    ...
    """Blend crowd signal + Bayesian prior into Beta(alpha, beta) parameters."""
